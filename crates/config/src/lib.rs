...
pub struct MappingConfig {
 ...
 pub yaw_pos_output_multiplier: f32,
 pub yaw_neg_output_multiplier: f32,
 pub pitch_pos_output_multiplier: f32,
 pub pitch_neg_output_multiplier: f32,
 pub yaw_pos_input_deadzone: f32,
 pub yaw_neg_input_deadzone: f32,
 pub pitch_pos_input_deadzone: f32,
 pub pitch_neg_input_deadzone: f32,
 pub yaw_pos_input_range_end: f32,
 pub yaw_neg_input_range_end: f32,
 pub pitch_pos_input_range_end: f32,
 pub pitch_neg_input_range_end: f32,
 pub yaw_pos_output_range_start: f32,
 pub yaw_neg_output_range_start: f32,
 pub pitch_pos_output_range_start: f32,
 pub pitch_neg_output_range_start: f32,
 pub ets2_relative_angular_velocity_deg_per_sec: f32,
 pub ets2_relative_accumulation_reset_enabled: bool,
 pub ets2_relative_accumulation_reset_timeout_secs: f32,
 pub ets2_relative_auto_return_angular_velocity_deg_per_sec: f32,
...
impl Default for MappingConfig {
 fn default() -> Self {
  Self {
   ...
   yaw_pos_output_multiplier: 1.0,
   yaw_neg_output_multiplier: 1.0,
   pitch_pos_output_multiplier: 1.0,
   pitch_neg_output_multiplier: 1.0,
   yaw_pos_input_deadzone: 0.0,
   yaw_neg_input_deadzone: 0.0,
   pitch_pos_input_deadzone: 0.0,
   pitch_neg_input_deadzone: 0.0,
   yaw_pos_input_range_end: 1.0,
   yaw_neg_input_range_end: 1.0,
   pitch_pos_input_range_end: 1.0,
   pitch_neg_input_range_end: 1.0,
   yaw_pos_output_range_start: 0.0,
   yaw_neg_output_range_start: 0.0,
   pitch_pos_output_range_start: 0.0,
   pitch_neg_output_range_start: 0.0,
   ets2_relative_angular_velocity_deg_per_sec: 120.0,
   ets2_relative_accumulation_reset_enabled: false,
   ets2_relative_accumulation_reset_timeout_secs: 1.5,
   ets2_relative_auto_return_angular_velocity_deg_per_sec: 60.0,
